...
class InceptionNet(BaseModel):
    ...
    def build_model(self, data_sources: Dict[str, BaseDataSource], mode: str):
        ...
        with tf.variable_scope('inception'):
            ...
            branch_pool = tf.layers.average_pooling2d(x, pool_size=(3, 3), strides=(1, 1), padding='same',
                                                      data_format='channels_first')
            ...
            branch_pool = tf.layers.max_pooling2d(x, pool_size=(3, 3), strides=(2, 2), padding='valid',
                                                  data_format='channels_first')
            ...
            x = tf.layers.average_pooling2d(x, pool_size=(2, 2), strides=(1, 1), padding='valid',
                                            data_format='channels_first')
